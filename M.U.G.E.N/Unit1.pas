...
begin
  cheat(1,$11234,$1b8,99000);
end;
If scheckbox2.checked then
begin
  cheat(1,$11234,$1d0,99000);
end;
If scheckbox3.checked then
begin
  cheat(1,$11234,$1f4,3273654272);
  cheat(1,$11234,$1f8,0);
end;
If scheckbox4.checked then
begin
  cheat(1,$11238,$1b8,99000);
end;
If scheckbox5.checked then
begin
  cheat(1,$11238,$1d0,99000);
end;
If scheckbox6.checked then
begin
  cheat(1,$11238,$1f4,1126170624);
  cheat(1,$11238,$1f8,0);
end;
